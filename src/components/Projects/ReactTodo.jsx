...
import { TECH, IMG_PROJECTS, REACTTODO_LINKS as LINK } from "../../constant";
import { openNewTab } from "../../utils/openNewTab";
import { I_CSS } from "../../assets/Tech/CSS";

const ProyectReactTodo = ({ changeDirection }) => {
  const { t } = useTranslation();

  return (
    <CardViewProjects
      changeDirection={changeDirection}
      title={t("projects.reactTodo.title")}
      content={t("projects.reactTodo.content")}
      imgSrc={IMG_PROJECTS.REACTTODO}
      linksViews={
        <>
          <CardViewIcon
